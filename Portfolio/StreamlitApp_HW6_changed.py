...
MODEL_INFO = {
        ...
        # Option 1 is Regression: inputs are sentiment scores in range [-1, 1]
...
def call_model_api(input_df):
    ...
    try:
        # Option 1 is Regression — return the predicted next-day return as a float
...
st.caption("Enter sentiment scores (TextBlob, range –1 to +1) for the four features below.")
...
with st.form("pred_form"):
    ...
    submitted = st.form_submit_button("Predict Next-Day Return")
