...
MODEL_INFO = {
        ...
        "keys": ["NVDA", 'AAPL', 'ORCL', 'DEXCAUS', 'DEXINUS','NASDAQCOM', 'VXNCLS', 'DGS10'],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["NVDA", 'AAPL', 'ORCL', 'DEXCAUS', 'DEXINUS','NASDAQCOM', 'VXNCLS', 'DGS10']]
}
